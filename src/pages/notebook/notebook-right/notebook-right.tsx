...
const createMethods = (t: (key: string) => string) => [
  ...
  {
    name: "read_text",
    description: t("functions.readText.description"),
    type: "table-valued" as FunctionType,
    params: [
      {
        name: "infer_schema",
        type: "boolean",
        default: true,
        desc: t("functions.readText.inferSchema"),
        example: "false",
        required: false,
      },
      {
        ...
        type: "boolean",
        default: true,
        desc: t("functions.readText.hasHeader"),
        example: "true",
        required: false,
      },
      {
        ...
        type: "string",
        default: "\\t",
        desc: t("functions.readText.delimiter"),
        example: ",",
        required: false,
      },
      {
        ...
        type: "string",
        default: ".txt",
        desc: t("functions.readText.fileExtension"),
        example: ".txt",
        required: false,
      },
    ],
    example: `select * from read_text('data.txt', infer_schema => false)`,
  },
  {
    name: "read_tsv",
