...
详细的产品与技术计划见 **[docs/ROADMAP.md](docs/ROADMAP.md)**（版本里程碑、优先级与实现要点）。下方为功能清单摘要。
...
详见 [docs/ROADMAP.md](docs/ROADMAP.md)。当前优先级：

- [ ] **v2.13** Excel 性能与类型完善（P0）
- [ ] **v2.14** 数据库连接配置、目录浏览与最近文件（P1）
- [ ] **v2.15** 多会话 / 多标签（P2）
- [ ] **v2.16+** S3 / HTTP 远程文件、EasyDB Server 联动（P3）
- [ ] 数据可视化（待用户反馈驱动）
